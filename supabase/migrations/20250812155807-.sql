-- Insert categories (checking if they don't exist first)
INSERT INTO public.categorias (nome) 
SELECT 'PRATO DO DIA' WHERE NOT EXISTS (SELECT 1 FROM categorias WHERE nome = 'PRATO DO DIA')
UNION ALL
SELECT 'EXECUTIVO' WHERE NOT EXISTS (SELECT 1 FROM categorias WHERE nome = 'EXECUTIVO')
UNION ALL
SELECT 'MASSAS' WHERE NOT EXISTS (SELECT 1 FROM categorias WHERE nome = 'MASSAS')
UNION ALL
SELECT 'LANCHES' WHERE NOT EXISTS (SELECT 1 FROM categorias WHERE nome = 'LANCHES')
UNION ALL
SELECT 'BEBIDAS' WHERE NOT EXISTS (SELECT 1 FROM categorias WHERE nome = 'BEBIDAS')
UNION ALL
SELECT 'CAFÉS' WHERE NOT EXISTS (SELECT 1 FROM categorias WHERE nome = 'CAFÉS')
UNION ALL
SELECT 'PORÇÕES' WHERE NOT EXISTS (SELECT 1 FROM categorias WHERE nome = 'PORÇÕES')
UNION ALL
