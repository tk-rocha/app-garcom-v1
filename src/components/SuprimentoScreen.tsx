...
const SuprimentoScreen = () => {
  ...
  const handleConfirm = () => {
    ...
    toast({
      ...
      description: `Entrada de ${valor} registrada com sucesso`
    });
          ...
          <CardContent className="p-6 space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  id="motivo"
                  placeholder="Digite o motivo do suprimento"
                  value={motivo}
...
export default SuprimentoScreen;